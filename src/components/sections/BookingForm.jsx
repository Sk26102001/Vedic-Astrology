...
//     // Reset after few seconds (optional)
//     setTimeout(() => setIsSubmitted(false), 4000);
//   };

//   return (
//     <section className="py-20 bg-gradient-to-br from-yellow-50 via-orange-50 to-yellow-100">
//       <div className="max-w-3xl mx-auto bg-white p-10 rounded-3xl shadow-2xl border border-orange-200">
//         <h2 className="text-4xl font-bold text-orange-700 text-center mb-8 drop-shadow-sm">
//           Book Your Personalized Kundali
//         </h2>
//         <p className="text-gray-600 text-center mb-10 max-w-xl mx-auto leading-relaxed">
//           Fill out the details below to receive your <b>personalized PDF
//           Kundali</b> in Hindi or English with deep insights about your life
//           journey.
//         </p>
...
//             <input
//               type="text"
//               className="w-full border border-orange-200 rounded-xl p-4 shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-400"
...
//           <button
//             type="submit"
//             className="w-full bg-gradient-to-r from-orange-500 to-yellow-500 text-white font-bold py-4 rounded-2xl shadow-lg hover:scale-105 transition-transform"
//           >
//             Book Now
//           </button>
//         </form>
...
//           >
//             <motion.div
//               className="bg-white p-8 rounded-3xl shadow-2xl text-center max-w-md mx-auto"
...
//             </label>
//             <select
//               className="w-full border border-yellow-300/60 rounded-xl p-4 shadow-sm bg-white/70 focus:outline-none focus:ring-2 focus:ring-yellow-500 transition-all appearance-none cursor-pointer"
//               required
//             >
//               <option value="">Select Gender</option>
//               <option>Male</option>
