...
//             src="./logo.png" 
//             alt="Vedic Kundli"
//             className="h-48 w-auto drop-shadow-[0_0_25px_rgba(255,215,0,0.7)]"
...
//           </p> */}
//           {/* <div className="flex gap-5 mt-2 text-yellow-200 text-2xl">
...
//               className="text-yellow-200 text-lg md:text-xl hover:text-yellow-50 transition hover:drop-shadow-[0_0_8px_rgba(255,215,0,0.7)]"
//             >
//               {link}
//             </a>
//           ))}
...
//           <div className="mt-4">
//             <h4 className="text-lg md:text-xl font-medium mb-2 text-yellow-200">Subscribe Newsletter</h4>
